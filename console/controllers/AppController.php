...
class AppController extends Controller
{
    ...
    public function actionSetDb()
    {
        do {
            ...
            $dbDbname = $this->prompt('dbname(不存在则自动创建)' . PHP_EOL, ['default' => 'yii_cmf']);
            $dbUsername = $this->prompt('dbusername(默认为中括号内的值)' . PHP_EOL, ['default' => 'root']);
            $dbPassword = $this->prompt('dbpassword(默认为中括号内的值)' . PHP_EOL, ['default' => '123456']);
            $dbPassword = '123456';
        ...
        $this->setEnv('DB_PASSWORD', '123456');
        $this->setEnv('DB_TABLE_PREFIX', 'yii2cmf_');

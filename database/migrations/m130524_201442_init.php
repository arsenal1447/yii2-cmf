...
// article
        $this->createTable('{{%article}}', [
            ...
            'category_id' => Schema::TYPE_INTEGER . "(11)  NOT NULL DEFAULT 0 ",
            'created_at' => Schema::TYPE_INTEGER . "(10)  NOT NULL DEFAULT 0 ",
            ...
            'source' => Schema::TYPE_STRING . "(50)  NOT NULL DEFAULT 0 ",
...
// article_tag
        $this->createTable('{{%article_tag}}', [
            'article_id' => Schema::TYPE_INTEGER . "(10)  NOT NULL DEFAULT 0 ",
            'tag_id' => Schema::TYPE_INTEGER . "(10)  NOT NULL DEFAULT 0 ",
        ], $this->tableOptions);
...
// auth
        $this->createTable('{{%auth}}', [
            'id' => Schema::TYPE_PK,
            'user_id' => Schema::TYPE_INTEGER . "(11)  NOT NULL DEFAULT 0 ",
            'source' => Schema::TYPE_STRING . "(255)  NOT NULL DEFAULT 0 ",
            'source_id' => Schema::TYPE_STRING . "(255)  NOT NULL DEFAULT 0 ",
        ], $this->tableOptions);
...
// category
        $this->createTable('{{%category}}', [
            ...
            'created_at' => Schema::TYPE_INTEGER . "(10)  NOT NULL DEFAULT 0 ",
            'updated_at' => Schema::TYPE_INTEGER . "(10)  NOT NULL DEFAULT 0 ",
            'slug' => Schema::TYPE_STRING . "(20)  NOT NULL DEFAULT 0 ",
...
// comment
        $this->createTable('{{%comment}}', [
            'id' => Schema::TYPE_PK,
            'user_id' => Schema::TYPE_INTEGER . "(11)  NOT NULL DEFAULT 0 ",
            'type_id' => Schema::TYPE_INTEGER . "(11)  NOT NULL DEFAULT 0 ",
            ...
            'type' => Schema::TYPE_STRING . "(20)  NOT NULL DEFAULT 0 ",
            'created_at' => Schema::TYPE_INTEGER . "(10)  NOT NULL DEFAULT 0 ",
            'updated_at' => Schema::TYPE_INTEGER . "(10)  NOT NULL DEFAULT 0 ",
        ], $this->tableOptions);
...
// favourite
        $this->createTable('{{%favourite}}', [
            'id' => Schema::TYPE_PK,
            'user_id' => Schema::TYPE_INTEGER . "(11)  NOT NULL DEFAULT 0 ",
            'article_id' => Schema::TYPE_INTEGER . "(11)  NOT NULL DEFAULT 0 ",
            'created_at' => Schema::TYPE_INTEGER . "(10)  NOT NULL DEFAULT 0 ",
        ], $this->tableOptions);
...
// gather
        $this->createTable('{{%gather}}', [
            'id' => Schema::TYPE_PK,
            'name' => Schema::TYPE_STRING . "(255)  NOT NULL DEFAULT 0 ",
            'category' => Schema::TYPE_STRING . "(255)  NOT NULL DEFAULT 0 ",
            'url' => Schema::TYPE_STRING . "(255)  NOT NULL DEFAULT 0 ",
            'url_org' => Schema::TYPE_STRING . "(255)  NOT NULL DEFAULT 0 ",
            'res' => Schema::TYPE_BOOLEAN . " NOT NULL DEFAULT '1'",
            'result' => Schema::TYPE_STRING . "(255)  NOT NULL DEFAULT 0 ",
        ], $this->tableOptions);

// menu
        $this->createTable('{{%menu}}', [
            'id' => Schema::TYPE_PK,
            'name' => Schema::TYPE_STRING . "(128)  NOT NULL DEFAULT 0 ",
...
// sign
        $this->createTable('{{%sign}}', [
            'id' => Schema::TYPE_PK,
            'user_id' => Schema::TYPE_INTEGER . "(11)  NOT NULL DEFAULT 0 ",
            'last_sign_at' => Schema::TYPE_INTEGER . "(10)  NOT NULL DEFAULT 0 ",
            'times' => Schema::TYPE_INTEGER . "(11)  NOT NULL DEFAULT 0 ",
            'continue_times' => Schema::TYPE_INTEGER . "(11)  NOT NULL DEFAULT 0 ",
        ], $this->tableOptions);
...
// subscribe
        $this->createTable('{{%subscribe}}', [
            'id' => Schema::TYPE_PK,
            'user_id' => Schema::TYPE_INTEGER . "(11)  NOT NULL DEFAULT 0 ",
            'email' => Schema::TYPE_STRING . "(30)  NOT NULL DEFAULT 0 ",
            'created_at' => Schema::TYPE_INTEGER . "(10)  NOT NULL DEFAULT 0 ",
            'updated_at' => Schema::TYPE_INTEGER . "(10)  NOT NULL DEFAULT 0 ",
        ], $this->tableOptions);
...
// tag
        $this->createTable('{{%tag}}', [
            'id' => Schema::TYPE_PK,
            'name' => Schema::TYPE_STRING . "(100)  NOT NULL DEFAULT 0 ",
